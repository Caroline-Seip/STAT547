...
str(wesanderson)
head(wesanderson)
#Base R way of getting the first elements of each vector
x <- character(0)
...
```{r}
# %>% pipes into first argument of function unless you use curly braces
got_chars %>% {
    tibble(
        name = map_chr(., "name"),
        born = map_chr(., "born")
